...
namespace Altinn.Dd.Correspondence.HttpClients
{
...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        /// <exception cref="AltinnCorrespondenceException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<CorrespondencesExt> CorrespondenceGETAsync(string resourceId, System.DateTimeOffset? from, System.DateTimeOffset? to, CorrespondenceStatusExt? status, CorrespondencesRoleType? role, string onBehalfOf, string sendersReference, System.Guid? idempotentKey)
        {
            return CorrespondenceGETAsync(resourceId, from, to, status, role, onBehalfOf, sendersReference, idempotentKey, System.Threading.CancellationToken.None);
        }
        ...
        public virtual async System.Threading.Tasks.Task<CorrespondencesExt> CorrespondenceGETAsync(string resourceId, System.DateTimeOffset? from, System.DateTimeOffset? to, CorrespondenceStatusExt? status, CorrespondencesRoleType? role, string onBehalfOf, string sendersReference, System.Guid? idempotentKey, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    {
                        urlBuilder_.Append(System.Uri.EscapeDataString("idempotentKey")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(idempotentKey, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
                    }
                    urlBuilder_.Length--;
        ...
        /// <param name="correspondence_MessageSender">An alternative name for the sender of the correspondence. The name, if set, will be displayed instead of the organization name in the inbox.</param>
        ...
        /// <param name="correspondence_Notification_CustomRecipients">A list of additional recipients for the notification. These are processed in addition to the Correspondence recipient;
        ...
        /// <param name="correspondence_Notification_OverrideRegisteredContactInformation">When set to true, only CustomRecipients will be used for notifications, overriding the default correspondence recipient.
        ...
        public virtual async System.Threading.Tasks.Task<InitializeCorrespondencesResponseExt> Upload2Async(string correspondence_ResourceId, string correspondence_Sender, string correspondence_SendersReference, string correspondence_MessageSender, string correspondence_Content_Language, string correspondence_Content_MessageTitle, string correspondence_Content_MessageSummary, string correspondence_Content_MessageBody, System.Collections.Generic.IEnumerable<InitializeCorrespondenceAttachmentExt> correspondence_Content_Attachments, System.DateTimeOffset? correspondence_RequestedPublishTime, System.DateTimeOffset? correspondence_AllowSystemDeleteAfter, System.DateTimeOffset? correspondence_DueDateTime, System.Collections.Generic.IEnumerable<ExternalReferenceExt> correspondence_ExternalReferences, System.Collections.Generic.IDictionary<string, string> correspondence_PropertyList, System.Collections.Generic.IEnumerable<CorrespondenceReplyOptionExt> correspondence_ReplyOptions, NotificationTemplateExt? correspondence_Notification_NotificationTemplate, string correspondence_Notification_EmailSubject, string correspondence_Notification_EmailBody, EmailContentType? correspondence_Notification_EmailContentType, string correspondence_Notification_SmsBody, bool? correspondence_Notification_SendReminder, string correspondence_Notification_ReminderEmailSubject, string correspondence_Notification_ReminderEmailBody, EmailContentType? correspondence_Notification_ReminderEmailContentType, string correspondence_Notification_ReminderSmsBody, NotificationChannelExt? correspondence_Notification_NotificationChannel, NotificationChannelExt? correspondence_Notification_ReminderNotificationChannel, string correspondence_Notification_SendersReference, System.DateTimeOffset? correspondence_Notification_RequestedSendTime, System.Collections.Generic.IEnumerable<NotificationRecipientExt> correspondence_Notification_CustomRecipients, string correspondence_Notification_CustomRecipient_EmailAddress, string correspondence_Notification_CustomRecipient_MobileNumber, string correspondence_Notification_CustomRecipient_OrganizationNumber, string correspondence_Notification_CustomRecipient_NationalIdentityNumber, bool? correspondence_Notification_CustomRecipient_IsReserved, System.Collections.Generic.IEnumerable<CustomNotificationRecipientExt> correspondence_Notification_CustomNotificationRecipients, bool? correspondence_Notification_OverrideRegisteredContactInformation, bool? correspondence_IgnoreReservation, System.DateTimeOffset? correspondence_Published, bool? correspondence_IsConfirmationNeeded, bool? correspondence_IsConfidential, System.Collections.Generic.IEnumerable<string> recipients, System.Collections.Generic.IEnumerable<System.Guid> existingAttachments, System.Guid? idempotentKey, System.Collections.Generic.IEnumerable<FileParameter> attachments, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    if (correspondence_Notification_CustomRecipients == null)
                        throw new System.ArgumentNullException("correspondence_Notification_CustomRecipients");
                    else
                    {
                        foreach (var item_ in correspondence_Notification_CustomRecipients)
                        {
                            content_.Add(new System.Net.Http.StringContent(ConvertToString(item_, System.Globalization.CultureInfo.InvariantCulture)), "Correspondence.Notification.CustomRecipients");
                        }
                    }
                    ...
                    if (correspondence_Notification_OverrideRegisteredContactInformation == null)
                        throw new System.ArgumentNullException("correspondence_Notification_OverrideRegisteredContactInformation");
                    else
                    {
                        content_.Add(new System.Net.Http.StringContent(ConvertToString(correspondence_Notification_OverrideRegisteredContactInformation, System.Globalization.CultureInfo.InvariantCulture)), "Correspondence.Notification.OverrideRegisteredContactInformation");
                    }
    ...
    public partial class AttachmentDetailsExt
    {
        ...
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        [System.Text.Json.Serialization.JsonConverter(typeof(System.Text.Json.Serialization.JsonStringEnumConverter<AttachmentStatusExt>))]
    ...
    public partial class BaseCorrespondenceExt
    {
        ...
        /// <summary>
        /// An alternative name for the sender of the correspondence. The name, if set, will be displayed instead of the organization name in the inbox.
        /// </summary>
        ...
        /// <br/>If an external reference of type DialogportenDialogId is set, a transmission will be created on the existing dialog instead.
        /// </summary>
    ...
    public partial class CorrespondenceAttachmentExt
    {
        ...
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        [System.Text.Json.Serialization.JsonConverter(typeof(System.Text.Json.Serialization.JsonStringEnumConverter<AttachmentDataLocationTypeExt>))]
    ...
    public partial class CorrespondenceDetailsExt
    {
        ...
        [System.Text.Json.Serialization.JsonPropertyName("status")]
        [System.Text.Json.Serialization.JsonConverter(typeof(System.Text.Json.Serialization.JsonStringEnumConverter<CorrespondenceStatusExt>))]
    ...
    public partial class ExternalReferenceExt
    {
        ...
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        [System.Text.Json.Serialization.JsonConverter(typeof(System.Text.Json.Serialization.JsonStringEnumConverter<ReferenceTypeExt>))]
    ...
    public partial class InitializeCorrespondenceAttachmentExt
    {
        ...
        [System.Text.Json.Serialization.JsonPropertyName("dataLocationType")]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        [System.Text.Json.Serialization.JsonConverter(typeof(System.Text.Json.Serialization.JsonStringEnumConverter<InitializeAttachmentDataLocationTypeExt>))]
    ...
    public partial class InitializeCorrespondenceNotificationExt
    {
        ...
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        [System.Text.Json.Serialization.JsonConverter(typeof(System.Text.Json.Serialization.JsonStringEnumConverter<NotificationTemplateExt>))]
        ...
        [System.Text.Json.Serialization.JsonConverter(typeof(System.Text.Json.Serialization.JsonStringEnumConverter<EmailContentType>))]
        ...
        [System.Text.Json.Serialization.JsonConverter(typeof(System.Text.Json.Serialization.JsonStringEnumConverter<NotificationChannelExt>))]
        ...
        /// <br/>if not set, only the Correspondence recipient receives the notification.
        /// </summary>
        [System.Text.Json.Serialization.JsonPropertyName("customRecipients")]
        public System.Collections.Generic.ICollection<NotificationRecipientExt> CustomRecipients { get; set; }
        ...
        /// <br/>This flag can only be used when CustomRecipients is provided.
        /// <br/>Default value is false (use default contact info + custom recipients).
        /// </summary>
        [System.Text.Json.Serialization.JsonPropertyName("overrideRegisteredContactInformation")]
    ...
    public partial class InitializedCorrespondencesNotificationsExt
    {
        ...
        [System.Text.Json.Serialization.JsonPropertyName("status")]
        [System.Text.Json.Serialization.JsonConverter(typeof(System.Text.Json.Serialization.JsonStringEnumConverter<InitializedNotificationStatusExt>))]
