...
{
    [Fact]
    public void OedMessageDetails_CanBeCreatedWithAllProperties()
    {
        // Arrange & Act
    ...
    [Fact]
    public void OedMessageDetails_CanBeCreatedWithMinimalProperties()
    {
        // Arrange & Act
        var messageDetails = OedMessageDetailsBuilder.Create()
            .WithRecipient("12345678901")
    ...
    [Fact]
    public void Settings_ImplementsIOedNotificationSettings()
    {
        // Arrange & Act
        var settings = SettingsBuilder.Create().WithValidDefaults().Build();

        // Assert
        settings.Should().BeAssignableTo<Models.Interfaces.IOedNotificationSettings>();
    }
}
