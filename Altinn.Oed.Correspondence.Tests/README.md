# Altinn.Oed.Correspondence.Tests

This project contains comprehensive unit and integration tests for the Altinn.Oed.Correspondence library.

## Test Structure

### Unit Tests
- **OedMessagingServiceTests**: Tests the core messaging service functionality
...
### Integration Tests
- **OedMessagingServiceIntegrationTests**: Tests dependency injection and service configuration

### Test Data Builders
- **OedMessageDetailsBuilder**: Builder pattern for creating test message details
...
dotnet test --filter "ClassName=OedMessagingServiceTests"
